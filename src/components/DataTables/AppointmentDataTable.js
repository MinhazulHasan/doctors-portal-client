...
import PrescriptionModal from '../DashboardComponents/PrescriptionModal';
...
const AppointmentDataTable = () => {
    ...
    const onSubmit = data => {
        ...
        fetch("https://cryptic-hollows-84804.herokuapp.com/updateAppointmentTime", {
            method: "POST",
            headers: {
    ...
    const handleStatusChange = status => {
        ...
        fetch("https://cryptic-hollows-84804.herokuapp.com/updateBookingStatus", {
            method: "POST",
            headers: {
                "Content-type": "application/json"
            },
